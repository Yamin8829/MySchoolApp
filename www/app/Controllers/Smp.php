...
class Smp extends BaseController
{
    ...
    public function indukSmp()
    {
        $siswaModel = new GetSiswaSmpModel();

        $dataSiswa = $siswaModel->join_all_data_smp()->where('status', 'Aktif')->get()->getResultArray();
        $names = ['2021'];
        // $dataSiswa = $siswaModel->join_all_data_smp()->whereIn('thn_ajaran_2', $names)->like('kls_2', '8')
        //     ->orderBy('kls_2', 'ASC')
        //     ->get()->getResultArray();
        ...
        $totalAktif = $siswaModel->like('status', 'Aktif')
            ->countAllResults();
        $totalKls7 = $siswaModel->join_all_data_smp()->where('status', 'Aktif')->like('kls_4', '7')
            ->countAllResults();
        $totalKls8 = $siswaModel->join_all_data_smp()->where('status', 'Aktif')->like('kls_4', '8')
            ->countAllResults();
        $totalKls9 = $siswaModel->join_all_data_smp()->where('status', 'Aktif')->like('kls_4', '9')
            ->countAllResults();
        $totalKls0 = $siswaModel->join_all_data_smp()->where('status', 'Aktif')->notLike('kls_4', '7')->notLike('kls_4', '8')->notLike('kls_4', '9')
            ->countAllResults();

        $siswa_per_kls9 = $siswaModel->join_all_data_smp()->select('kls_4, COUNT(id_siswa_smp) AS jumlahSiswaKls')->where('status', 'Aktif')->like('kls_4', '9')
            ->groupBy('kls_4')
            ->get();
        $siswa_per_kls8 = $siswaModel->join_all_data_smp()->select('kls_4, COUNT(id_siswa_smp) AS jumlahSiswaKls')->where('status', 'Aktif')->like('kls_4', '8')
            ->groupBy('kls_4')
            ->get();
        $siswa_per_kls7 = $siswaModel->join_all_data_smp()->select('kls_4, COUNT(id_siswa_smp) AS jumlahSiswaKls')->where('status', 'Aktif')->like('kls_4', '7')
            ->groupBy('kls_4')
            ->get();
        $siswa_per_kls0 = $siswaModel->join_all_data_smp()->select('kls_4, COUNT(id_siswa_smp) AS jumlahSiswaKls')->where('status', 'Aktif')->notLike('kls_4', '7')->notLike('kls_4', '8')->notLike('kls_4', '9')
            ->groupBy('kls_4')
            ->get();
        // dd($siswa_per_kls);
        ...
        $siswa_per_gender = $siswaModel->select('gender_siswa, COUNT(id_siswa_smp) AS jumlahSiswa')
            ...
            ->get();
        $siswa_per_thn = $siswaModel->join_all_data_smp()->select('thn_ajaran_1, COUNT(id_siswa_smp) AS jumlahSiswa2')
            ->groupBy('thn_ajaran_1')
            ->get();
        $siswa_per_mutasi = $siswaModel->join_all_data_smp()->select('status, COUNT(id_siswa_smp) AS jumlahSiswa3')
            ->groupBy('status')
            ->get();
        // dd($totalLulus);
        // dd($dataSiswa);
    ...
    public function lulus()
    {
        ...
        $dataSiswa = $siswaModel->join_all_data_smp()->where('status', 'Lulus')->get()->getResultArray();
        $names = ['2021'];
        // $dataSiswa = $siswaModel->join_all_data_smp()->whereIn('thn_ajaran_2', $names)->like('kls_2', '8')
        //     ->orderBy('kls_2', 'ASC')
        //     ->get()->getResultArray();
        ...
        return view('smpContent/lulusSmp', $data);
    }
...
//
        ...
        if ($search == '') {
            ...
            $searchDataSmp = $siswaModel->get_all_data_smp();
        } else {
            $searchDataSmp = $siswaModel->select('*')
                ->join('siswa_smp_data_sekolah', 'siswa_smp_data_sekolah.data_id_siswa_smp = siswa_smp.id_siswa_smp')
                ->Like('nis_siswa_smp', $search)->get();

            $writer = user()->username;

            $dataSiswa = $searchDataSmp->getResultArray();
            // dd($dataSiswa);
        ...
        return view('smpContent/searchData', $data);
    }

    public function editSmp($nis)
    {
//
        ...
        return view('smpContent/editSmp', $data);
    }
...
//
        ...
        $siswaModel->where('id_siswa_smp', $id)->delete();
        $totalSiswa = $siswaModel->countAll();
        session()->markAsTempdata('pesan', 3);
    ...
    public function index()
    {
        ...
        return view('smpContent/indexSmp', $data);
    }

    public function tahunSmp($thn_ajaran_1)
    {
        $siswaModel = new GetSiswaSmpModel();
        $lm = 50;
        $off = 0;

        $dataSiswa = $siswaModel->join_all_data_smp()->where('thn_ajaran_1', $thn_ajaran_1)->orderBy('nis_siswa_smp', 'ASC')->limit($lm, $off)->get()->getResultArray();
        $dataSiswa2 = $siswaModel->join_all_data_smp()->where('thn_ajaran_1', $thn_ajaran_1)->orderBy('nis_siswa_smp', 'ASC')->limit($lm, 50)->get()->getResultArray();
        $dataSiswa3 = $siswaModel->join_all_data_smp()->where('thn_ajaran_1', $thn_ajaran_1)->orderBy('nis_siswa_smp', 'ASC')->limit($lm, 100)->get()->getResultArray();
        $dataSiswa4 = $siswaModel->join_all_data_smp()->where('thn_ajaran_1', $thn_ajaran_1)->orderBy('nis_siswa_smp', 'ASC')->limit($lm, 150)->get()->getResultArray();
        $dataSiswa5 = $siswaModel->join_all_data_smp()->where('thn_ajaran_1', $thn_ajaran_1)->orderBy('nis_siswa_smp', 'ASC')->limit($lm, 200)->get()->getResultArray();
        $dataSiswa6 = $siswaModel->join_all_data_smp()->where('thn_ajaran_1', $thn_ajaran_1)->orderBy('nis_siswa_smp', 'ASC')->limit($lm, 250)->get()->getResultArray();
        $dataSiswa7 = $siswaModel->join_all_data_smp()->where('thn_ajaran_1', $thn_ajaran_1)->orderBy('nis_siswa_smp', 'ASC')->limit($lm, 300)->get()->getResultArray();
        $dataSiswa8 = $siswaModel->join_all_data_smp()->where('thn_ajaran_1', $thn_ajaran_1)->orderBy('nis_siswa_smp', 'ASC')->limit($lm, 350)->get()->getResultArray();
        $dataSiswa9 = $siswaModel->join_all_data_smp()->where('thn_ajaran_1', $thn_ajaran_1)->orderBy('nis_siswa_smp', 'ASC')->limit($lm, 400)->get()->getResultArray();
        $dataSiswa10 = $siswaModel->join_all_data_smp()->where('thn_ajaran_1', $thn_ajaran_1)->orderBy('nis_siswa_smp', 'ASC')->limit($lm, 450)->get()->getResultArray();
        ...
        $totalAktif = $siswaModel->like('status', 'Aktif')
            ->countAllResults();
        $totalKls7 = $siswaModel->join_all_data_smp()->like('kls_4', '7')
            ->countAllResults();
        $totalKls8 = $siswaModel->join_all_data_smp()->like('kls_4', '8')
            ->countAllResults();
        $totalKls9 = $siswaModel->join_all_data_smp()->like('kls_4', '9')
            ->countAllResults();
        $siswa_per_kls = $siswaModel->join_all_data_smp()->select('kls_4, COUNT(id_siswa_smp) AS jumlahSiswaKls')->like('kls_4', '9')
            ->groupBy('kls_4')
            ->get();
        $siswa_per_kls8 = $siswaModel->join_all_data_smp()->select('kls_4, COUNT(id_siswa_smp) AS jumlahSiswaKls')->like('kls_4', '8')
            ->groupBy('kls_4')
            ->get();
        $siswa_per_kls7 = $siswaModel->join_all_data_smp()->select('kls_4, COUNT(id_siswa_smp) AS jumlahSiswaKls')->like('kls_4', '7')
            ->groupBy('kls_4')
            ->get();
        // dd($siswa_per_kls);
        ...
        $nis = $siswaModel->like('nis_siswa_smp', 2021)
            ->get()->getResultArray();
        $siswa_per_thn = $siswaModel->join_all_data_smp()->select('thn_ajaran_2, COUNT(id_siswa_smp) AS jumlahSiswa2')
        ...
        return view('smpContent/cetakInduk/tahunInduk', $data);
    }

    public function kelasSmp($kls_4)
    {
        $siswaModel = new GetSiswaSmpModel();

        $dataSiswa = $siswaModel->join_all_data_smp()->where('status', 'Aktif')->like('kls_4', $kls_4)->get()->getResultArray();
        $names = ['2021'];
        // $dataSiswa = $siswaModel->join_all_data_smp()->whereIn('thn_ajaran_2', $names)->like('kls_2', '8')
        //     ->orderBy('kls_2', 'ASC')
        //     ->get()->getResultArray();
        ...
        return view('smpContent/kelas', $data);
    }
    ...
    public function createSmp()
    {
        ...
        $data = [
            ...
            'thn' => '2020-2021',
            'totalSiswa' => $totalSiswa,
            'title' => 'Create Data SMP',
            'time' => Time::parse(date('F d, Y l. h:i A', strtotime(user()->created_at)))->humanize(),
        ];
        return view('smpContent/createSmp', $data);
    }
    public function inputSmp()
    {
        //
        $siswaModel = new GetSiswaSmpModel();
        ...
        return view('smpContent/inputSmp', $data);
    }
    ...
    public function importSiswa()
    {
        ...
        foreach ($sheet7a as $key => $dataE7) {
            ...
            // dd($dataE7[4]);
            // dd($siswaModel);
            // $this->db->table('siswa_smp')->where('nis_siswa_smp', $dataE7[1])->get();

            $nis = $siswaModel->cekDataSmp($dataE7[0]);
            // dd($nis);

            // dd($nis['nis_siswa_smp'],$dataE7[1]);
            ...
            $dataE7 = array(
                ...
                'nis_siswa_smp' => $dataE7['0'],
                'nama_lengkap_siswa' => $dataE7['1'],
                'gender_siswa' => $gender,
                'nik_siswa_smp' => $dataE7['3'],
                'nisn' => $dataE7['4'],
            ...
            $siswaModel->import_data_smp($dataE7, $dataSekolah);
        }
    ...
    public function updateSmp($id)
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/Smp/edit/' . $this->request->getVar('slug'))->withInput();
        }
        $dataSekolah = array(
    ...
    public function saveSmp()
    {
        ...
        // $db20_21 = db_connect('dbTahun20_21');
        $siswaModel = new GetSiswaSmpModel();
        $nis = $siswaModel->cekDataSmp($this->request->getVar('nis_siswa_smp'));
        if ($nis) {
            $nisnya = $nis['nis_siswa_smp'];
            if ($this->request->getVar('nis_siswa_smp') == $nisnya) {
                ...
                return redirect()->to('/Smp/create')->withInput();
            }
        }
        ...
        $data = array(
            'nis_siswa_smp' => $this->request->getVar('nis_siswa_smp'),
        ...
        // dd($data);
        $dataSekolah = array();
        $siswaModel->insert_data_Smp($data, $dataSekolah);
