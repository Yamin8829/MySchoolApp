...
class Siswa extends Migration
{
    ...
    public function up()
    {
        //
        $fields = [
            'id_siswa_6thn' => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'auto_increment' => true],
            'nis_siswa_6thn' => ['type' => 'int', 'constraint' => 225, 'default' => 0],
            ...
            'berat_badan_5' => ['type' => 'varchar', 'constraint' => 225, 'default' => '-'],
            'berat_badan_6' => ['type' => 'varchar', 'constraint' => 225, 'default' => '-'],
            ...
            'tinggi_badan_5' => ['type' => 'varchar', 'constraint' => 225, 'default' => '-'],
            'tinggi_badan_6' => ['type' => 'varchar', 'constraint' => 225, 'default' => '-'],
        ...
        $this->forge->addKey('id_siswa_6thn', true);
        $this->forge->createTable('siswa_6thn', true);
    }
    ...
    public function down()
    {
        ...
        $this->forge->dropTable('siswa_6thn', true);
    }
}
