...
class SiswaDataSma extends Migration
{
    ...
    public function up()
    {
        //
        $fields = [
            'data_id_siswa_sma' => ['type' => 'int', 'constraint' => 11, 'unsigned' => true],
        ...
        $this->forge->addKey(['data_id_siswa_sma']);
        $this->forge->addForeignKey('data_id_siswa_sma', 'siswa_sma', 'id_siswa_sma', '', 'CASCADE');
        $this->forge->createTable('siswa_sma_data_sekolah', true);
    }
    ...
    public function down()
    {
        ...
        {
            $this->forge->dropForeignKey('siswa_sma_data_sekolah', 'siswa_sma_data_sekolah_data_id_siswa_sma_foreign');
        }

        $this->forge->dropTable('siswa_sma_data_sekolah', true);
    }
}
