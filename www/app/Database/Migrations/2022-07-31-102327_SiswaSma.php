...
class SiswaSma extends Migration
{
    ...
    public function up()
    {
        //
        $fields = [
            'id_siswa_sma' => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'auto_increment' => true],
            'nis_siswa_sma' => ['type' => 'int', 'constraint' => 225, 'default' => 0],
        ...
        $this->forge->addKey('id_siswa_sma', true);
        $this->forge->createTable('siswa_sma', true);
    }
    ...
    public function down()
    {
        ...
        $this->forge->dropTable('siswa_sma', true);
    }
}
