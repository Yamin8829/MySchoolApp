...
<div class="col-12 d-flex">
  <div class="col-4">
      <form action="<?=base_url() . '/Sma/save';?>" method="post">
						<?=csrf_field()?>

            <div class="my-input-group ">

          <input type="text" name="nis_siswa_sma" class="form-control <?php if (session('pesan')): ?>is-invalid<?php endif?>" value=""  required>
            <span  class="bar"></span>
