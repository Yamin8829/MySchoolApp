...
<div class="body">
        ...
        <div class="mt-3 col-md-12">
                  <div class="card bg-gradient-lightblue collapsed-card">
                    <div class="card-header">
                      <h3 class="card-title">Kelas 10  <span class="badge badge-success right"> <?=$totalKls7;?> siswa</span></h3>
            ...
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
              <a  class="btn btn-info" href="<?=base_url() . '/Sma/kelas/' . $dataKls['kls_4'];?>">
                ...
                <div class="mt-3 col-md-12">
                  <div class="card bg-gradient-primary collapsed-card">
                    <div class="card-header">
                      <h3 class="card-title">Kelas 11 <span class="badge badge-success right"> <?=$totalKls8;?> siswa</span></h3>
              ...
              <a  class="btn btn-info" href="<?=base_url() . '/Sma/kelas/' . $dataKls['kls_4'];?>">
                ...
                <div class="mt-3 col-md-12">
                  <div class="card bg-gradient-indigo collapsed-card">
                    <div class="card-header">
                      <h3 class="card-title">Kelas 12 <span class="badge badge-success right"> <?=$totalKls9;?> siswa</span></h3>
                ...
                <button class="btn btn-navbar" type="submit">
                  ...
                  <?php foreach ($dt7a as $dt): ?>
                        <tr>
                          ...
                          <td><div class="d-flex"> <a href="<?=base_url();?>/SiswaSma/data/<?=$dt['slug'];?>/<?=$dt['nis_siswa_sma']?>" class="btn btn-sm btn-success">Detail</a>
                          <a href="<?=base_url();?>/Sma/edit/<?=$dt['slug'];?>/<?=$dt['nis_siswa_sma']?>" class="mx-2 btn btn-sm btn-warning">Edit</a>
