...
<div class="row">
                    ...
                    <div class="col-xs-9">
                      ...
                      <?php endif;?>
                      <?php if ($thn == '2019-2020'): ?>
                      <a href="<?=base_url($linkSMP . '/edit8c1920') . '/' . $siswa7a['slug'];?>" class="btn btn-primary"><i class="fa fa-edit m-right-xs"></i> Edit </a>
                      <?php endif;?>
                      ...
                      <?php endif;?>
                      <?php if ($thn == '2019-2020'): ?>
                      <a href="<?=base_url($linkSMP . 'edit8c1920') . '/' . $siswa7a['slug'];?>" class="btn btn-success"><i class="fa fa-edit m-right-xs"></i> Edit </a>
                      <?php endif;?>
                      </div>
                      </div>
...
<li><i class="fa fa-thumb-tack"></i> Hubungan dengan peserta didik : <?=$siswa7a['status_dgn_sswa'];?></li>
                    ...
                    <div class="ml-1 col-sm-4">
                        <div class="image">
                         ...
                         <?php endif;?>
                         <?php if ($thn == '2020-2021'): ?>
                         src="<?=base_url('/assets/images/dk20_21/SMP/kls8/8c') . "/" . $siswa7a['img'];?>"<?php endif;?> alt="image">
