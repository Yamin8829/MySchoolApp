            ...
            <div class="overflow-auto"> <table id="example1" class="table table-bordered table-hover  table-striped">
                  ...
                  <?php foreach ($dt7a as $dt): ?>
                        <tr>
                          ...
                          <td class=" d-flex"> <a href="<?=base_url();?>/dataKelas7/data7a20_21/<?=$dt['slug'];?>" class="btn btn-sm btn-success">Detail</a>
                          <a href="<?=base_url('/edit7a20_21/') . $dt['slug'];?>" class="mx-2 btn btn-sm btn-warning">Edit</a>
