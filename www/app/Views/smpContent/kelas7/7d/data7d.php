          ...
          <?php endif;?>
                ...
                <ul class="nav ">
                    ...
                    <table class="table table-hover">
                      ...
                      <?php foreach ($dt7d as $dt): ?>
                        <tr>

                          <td><?=$dt['nis'];?></td>
                          <td>
                          <?php if ($thn == '2019-2020'): ?>
                            <img width="100" height="100" class="img-fluid rounded-circle" src="<?=base_url('/assets/images/dk19_20/SMP/kls7/7d') . "/" . $dt['img'];?>" alt="">
                          <?php endif;?>
                          <?php if ($thn == '2020-2021'): ?>
                            <img width="100"height="100" class="img-fluid  rounded-circle rounded-circle" src="<?=base_url('/assets/images/dk20_21/SMP/kls7/7d') . "/" . $dt['img'];?>" alt="">
                            <?php endif;?>
                        </td>
                          <td><?=$dt['nama'];?></td>
                          <td><?=$dt['tmp_lahir'];?></td>
                         ...
                         <td>
                        <?php if ($thn == '2019-2020'): ?>
                         <a class="btn btn-sm btn-info" href="<?=base_url($linkSMP);?>/dataKelas7/data7d19_20/<?=$dt['slug'];?>" >
                            Detail </a>
                         <?php endif;?>
                     <?php if ($thn == '2020-2021'): ?>
                            <a class="btn btn-sm btn-info" href="<?=base_url($linkSMP);?>/dataKelas7/data7d20_21/<?=$dt['slug'];?>" >
                            Detail </a>
                      <?php endif;?>
                      <?php if ($thn == '2019-2020'): ?>
                            <form class="d-inline" method="post" action="<?=base_url($linkSMP);?>/delete1920_7d/<?=$dt['id'];?>">
                            <?php endif;?>
                            <?php if ($thn == '2020-2021'): ?>
