                    ...
                    <table class="table table-hover">
                      ...
                      <?php foreach ($dt7a as $dt): ?>
                        <tr>
                          ...
                          <td>
                          <?php if ($thn == '2019-2020'): ?>
                            <img width="100" height="100" class="img-fluid rounded-circle" src="<?=base_url('/assets/images/dk19_20/SMP/kls8/8b') . "/" . $dt['img'];?>" alt="">
                          <?php endif;?>
                          <?php if ($thn == '2020-2021'): ?>
                            <img width="100"height="100" class="img-fluid  rounded-circle rounded-circle" src="<?=base_url('/assets/images/dk20_21/SMP/kls8/8b') . "/" . $dt['img'];?>" alt="">
                            <?php endif;?>
                        </td>
                          <td><?=$dt['nama'];?></td>
                          <td><?=$dt['tmp_lahir'];?></td>
                         ...
                         <td>
                        <?php if ($thn == '2019-2020'): ?>
                         <a class="btn btn-sm btn-info" href="<?=base_url($linkSMP);?>/dataKelas8/data8b19_20/<?=$dt['slug'];?>" >
                            Detail </a>
                         <?php endif;?>
                     <?php if ($thn == '2020-2021'): ?>
                            <a class="btn btn-sm btn-info" href="<?=base_url($linkSMP);?>/dataKelas8/data8b20_21/<?=$dt['slug'];?>" >
                            Detail </a>
                      <?php endif;?>
                      <?php if ($thn == '2019-2020'): ?>
                            <form class="d-inline" method="post" action="<?=base_url($linkSMP);?>/delete1920_7a/<?=$dt['id'];?>">
                            <?php endif;?>
                            <?php if ($thn == '2020-2021'): ?>
