...
<?=view('coreTemplates/topbar');?>
  ...
  <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Gender Chart For SMP</h3>
...
<div class="card-footer bg-transparent">
  <div class="row">
    ...
    <div class="col-4 text-center">
      ...
      <div class="text-white">Non-Active</div>
    </div>
    <!-- ./col -->
  </div>
  <!-- /.row -->
...
<!-- /.card -->
  ...
  <?=$this->include('coreTemplates/charts');?>
  <?=$this->endSection();?>