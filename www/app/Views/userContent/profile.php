            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link" href="#activity" data-toggle="tab">About me</a></li>
                  <li class="nav-item"><a class="nav-link active" href="<?=base_url() . '/User/edit/' . user()->username;?>">Edit</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
